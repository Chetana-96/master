...
export class MenuNavComponent implements OnInit {
 ...
 closeResult: string;
  ...
  constructor(private modalService: NgbModal,private _data:MenuNavbarService) { }
...
onRenderCell(args: RenderCellEventArgs): void {
  ...
  // this._data.getAllLocation().subscribe(
  //   (data1: Location[])=>{
  //     this.arr1=data1;
  //   }
  // );
  ...
  //   return this.streets._filter(street => this._normalizeValue(street).includes(filterValue));
  // }
